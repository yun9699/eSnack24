  ...
  <div class="container mx-auto p-6 bg-gray-50 rounded-lg shadow-lg">
    ...
    <div class="space-y-4">
      ...
      <div class="flex justify-between items-center p-4 bg-white rounded-lg shadow-md">
        <span class="text-lg font-medium text-gray-700">총액</span>
